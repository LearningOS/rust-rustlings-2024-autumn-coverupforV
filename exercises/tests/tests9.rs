...
mod Foo {
    #[no_mangle] // Suppress name mangling for this function
    pub fn my_demo_function(a: u32) -> u32 {
        a
    }

    #[no_mangle] // Suppress name mangling for this alias function
    #[link_name = "my_demo_function"] // Make this function an alias
